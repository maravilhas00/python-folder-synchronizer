...
def folder_synchronizer(source_folder, replica_folder, log_file_path):
    ...
    for root, dirs, files in os.walk(source_folder):
        ...
        if not os.path.exists(replica_path):
            ...
            log_entries(f"Created folder {replica_path}", log_file_path)
        ...
        for file in files:
            ...
            if (not os.path.exists(replica_file) or os.path.getmtime(source_file)>os.path.getmtime(replica_file)):
                ...
                log_entries(f"Copied file ({file}) to {replica_path}", log_file_path)
    ...
    for root, dirs, files in os.walk(replica_folder, topdown=False):
        ...
        for file in files:
            ...
            if not os.path.exists(source_file):
                ...
                log_entries(f"Deleted file ({file}) from {root}", log_file_path)
        ...
        for dir in dirs:
            ...
            if not os.path.exists(source_sub_folder):
                ...
                log_entries(f"Deleted folder {root}", log_file_path)
